...
def hash(pii_csv, secret, schema, clk_json, no_header, check_header, validate, verbose):
    ...
    print(
        "This command is deprecated. Please use this command to encode your data - anonlink encode private_data.csv secret schema.json output-clks.json"
    )
...
@verbose_option
def encode(
    pii_csv, secret, schema, clk_json, no_header, check_header, validate, verbose
):
