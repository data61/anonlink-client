...
# -*- coding: utf-8 -*-
#
# Anonlink-client documentation build configuration file
#
...
htmlhelp_basename = 'Anonlinkclientdoc'
...
latex_documents = [
    (master_doc, 'Anonlinkclient.tex', 'Anonlink Client Documentation',
     'Confidential Computing', 'manual'),
]
...
man_pages = [
    (master_doc, 'anonlinkclient', 'Anonlink Client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Anonlinkclient', 'Anonlink Client Documentation',
     author, 'Anonlinkclient', 'One line description of project.',
     'Miscellaneous'),
]
